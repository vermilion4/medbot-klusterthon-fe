...
const ExpandSearchCauses = ({source, title, description}) => {
      ...
      <div className='w-[75vw] px-5 overflow-x-hidden lg:w-[85%] mx-auto'>
        <Breadcrumb
          ...
          items={[
            ...
            {
              title: `${source === 'symptom' ? 'Symptom Assessment' : 'Health Activity'}`,
              href: `${source === 'symptom' ? '/dashboard/symptom-assessment' : '/dashboard/health-activity'}`
            },
            {
              title: `${title}`,
            },
